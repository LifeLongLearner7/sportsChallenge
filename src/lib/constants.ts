...
export const FACTIONS: AvatarOption[] = [
  ...
  { id: "serpent", name: "Venom Serpent", bg: "bg-green-500/20", color: "text-green-500", glow: "shadow-green-500/20", icon: Shield }
];
...
export const ALL_IDENTITIES = [...AVATARS, ...FACTIONS];
